...
the tolerance counterpart to the minimum inhibitory concentration [[R2]][[R3]].
...
there to prophage induction rather than to an assay floor [[R70]]. That report
...
[[R5]][[R51]]; the class thresholds are not stated there and are recovered here
...
written protocol [[R4]][[R23]], a concentration-by-time grid in the same organism
[[R7]][[R37]], a panel of evolved clones in which the concentration and duration
axes can be checked for independence [[R38]], and a hollow-fibre deposit
[[R8]][[R36]] held out until every boundary was fixed (Table 1). Both boundaries
...
so the reading is flagged rather than treated as a measured time zero. <!--supp-->
...
sputum and rise during chemotherapy [[R64]], both dependent and independent
differentially culturable populations are recovered from patients whose
solid-medium cultures return nothing [[R65]], and rifamycin action on
ribonucleic acid (RNA) polymerase converts a starved population to over 90
per cent differentially detectable in vitro [[R66]], the same drug class
...
the drug worked, and 240 of 310 could not have demonstrated five** (Table S11); one could not have shown four logs in a single one of its 123 series.
...
Section 11 reports, not manufacture it. The experiment cannot exclude
...
independent, listed one line at a time (Table S8): twenty survive
...
isolate [[R5]]. Of the 217 rows, 43 are follow-up isolates from patients
...
[[R23]][[R4]]. Moxifloxacin and isoniazid at one and ten times the minimum
...
1.60 log10 within a single flask-visit [[R34]]. The file holds 2,775
...
inhibitory concentration and a persister fraction [[R38]][[R6]]. Six of
...
[[R37]][[R7]]. The 1 µg/mL arm shows net growth rather than killing and is
...
below-limit readings retained as a placeholder [[R36]][[R8]]. It was the
...
it; it is used nowhere else except to confirm them (Section 9).
