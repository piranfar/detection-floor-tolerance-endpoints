...
(Fig. S1A), so for half the laboratories the first-crossing time is right-censored
throughout.
...
no such correspondence (Fig. 2B). Institute F, with the highest starting density
...
rises from 0.896 to 0.930 (Fig. S1B). Institute C moves the other way, from 3.0 to
