"""JINDANI2003_SGUL -- serial sputum colony counts from an early bactericidal
...
def read(d: Path) -> pd.DataFrame:
    ...
    basis_tmpl = (
        "DERIVED, NOT STATED. The deposit gives no limit of detection, no "
        "limit of quantification and no plated volume anywhere. Its own "
